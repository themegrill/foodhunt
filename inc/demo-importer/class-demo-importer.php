...
/**
 * FoodHunt_Demo_Importer Class.
 */
class FoodHunt_Demo_Importer {
	...
	public function __construct() {
		$this->plugin_data = array(
			...
			'name' => __( 'ThemeGrill Demo importer', 'foodhunt' ),
		);
	...
	public function add_admin_menu() {
		add_theme_page( __( 'Demo Importer', 'foodhunt' ), __( 'Demo Importer', 'foodhunt' ), 'switch_themes', 'demo-importer', array( $this, 'demo_importer' ) );
	}
