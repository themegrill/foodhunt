	...
	class FoodHunt_Admin {
		...
		public function supported_plugins_screen() {
			...
			<div class="wrap about-wrap">
				...
				<ol>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/social-icons/' ); ?>" target="_blank"><?php esc_html_e( 'Social Icons', 'foodhunt' ); ?></a>
						<?php esc_html_e( ' by ThemeGrill', 'foodhunt' ); ?>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/easy-social-sharing/' ); ?>" target="_blank"><?php esc_html_e( 'Easy Social Sharing', 'foodhunt' ); ?></a>
						<?php esc_html_e( ' by ThemeGrill', 'foodhunt' ); ?>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/restaurantpress/' ); ?>" target="_blank"><?php esc_html_e( 'RestaurantPress', 'foodhunt' ); ?></a>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/everest-forms/' ); ?>" target="_blank"><?php esc_html_e( 'Everest Forms – Easy Contact Form and Form Builder', 'foodhunt' ); ?></a>
						<?php esc_html_e( ' by WPEverest', 'foodhunt' ); ?></li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/wp-pagenavi/' ); ?>" target="_blank"><?php esc_html_e( 'WP-PageNavi', 'foodhunt' ); ?></a>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/woocommerce/' ); ?>" target="_blank"><?php esc_html_e( 'WooCommerce', 'foodhunt' ); ?></a>
						<?php esc_html_e( 'Fully Compatible in Pro Version', 'foodhunt' ); ?>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/the-events-calendar/' ); ?>" target="_blank"><?php esc_html_e( 'The Events Calendar', 'foodhunt' ); ?></a>
						<?php esc_html_e( 'Fully Compatible in Pro Version', 'foodhunt' ); ?>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/polylang/' ); ?>" target="_blank"><?php esc_html_e( 'Polylang', 'foodhunt' ); ?></a>
						<?php esc_html_e( 'Fully Compatible in Pro Version', 'foodhunt' ); ?>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wpml.org/' ); ?>" target="_blank"><?php esc_html_e( 'WPML', 'foodhunt' ); ?></a>
						<?php esc_html_e( 'Fully Compatible in Pro Version', 'foodhunt' ); ?>
					</li>
				</ol>
