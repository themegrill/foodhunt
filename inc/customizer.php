...
function foodhunt_customizer_custom_scripts() { ?>
	<style>
		...
		li#accordion-section-foodhunt_important_links h3.accordion-section-title, li#accordion-section-foodhunt_important_links h3.accordion-section-title:focus {
			background-color: #32C4D1 !important;
			color: #fff !important;
		}

		li#accordion-section-foodhunt_important_links h3.accordion-section-title:hover {
			background-color: #32C4D1 !important;
			color: #fff !important;
		}

		li#accordion-section-foodhunt_important_links h3.accordion-section-title:after {
			color: #fff !important;
		}
