...
function foodhunt_customize_register( $wp_customize ) {
	...
	// Header Media Placement
 	$wp_customize->add_setting(
 	    'foodhunt_header_media_placement',
 		array(
 	...
 	$wp_customize->add_control(
 		'foodhunt_header_media_placement',
 		array(
 			'label'    => esc_html__( 'Choose the required option for Header Media placement', 'foodhunt' ),
 			'section'  => 'header_image',
 			'type'     => 'radio',
 			'choices'  => array(
 				'header_media_above_site_title' => esc_html__( 'Position One: Display Header Media just above the site Title/Text', 'foodhunt' ),
 				'header_media_below_main_menu' => esc_html__( 'Postion Two: Display Header Media just below the Main/Primary Menu', 'foodhunt' ),
 			)
 		)
 	);
